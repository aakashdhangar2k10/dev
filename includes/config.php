...
//Database Constants
defined('DB_SERVER') ? null : define("DB_SERVER","mysql-200-138.mysql.prositehosting.net");//define our database server
defined('DB_USER') ? null : define("DB_USER","smallarray");		  //define our database user	
defined('DB_PASS') ? null : define("DB_PASS","!sM@11DBee25");			  //define our database Password	
defined('DB_NAME') ? null : define("DB_NAME","cheshamvansdb"); //define our database Name
