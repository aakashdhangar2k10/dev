                ...
                <div class="tab-content settings-tab-content">
                    ...
                    <div class="tab-pane <?= $tab == "posts" ? 'active' : ''; ?>" id="tab_3">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <label><?= trans('show_post_type'); ?></label>
                                </div>
                                <div class="col-sm-6 col-md-5 col-xs-12 col-option">
                                    <input type="radio" name="show_post_type" value="1" id="show_post_type_1" class="square-purple" <?= $generalSettings->show_post_type == 1 ? 'checked' : ''; ?>>
                                    <label for="show_post_type_1" class="option-label"><?= trans('yes'); ?></label>
                                </div>
                                <div class="col-sm-6 col-md-7 col-xs-12 col-option">
                                    <input type="radio" name="show_post_type" value="0" id="show_post_type_2" class="square-purple" <?= $generalSettings->show_post_type != 1 ? 'checked' : ''; ?>>
                                    <label for="show_post_type_2" class="option-label"><?= trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
