              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" id="vehicle_no" name="vehicle_no" class="form-control text-uppercase bold-select"  placeholder="Enter Vehicle No" value="<?php echo htmlspecialchars($vehicleNo); ?>" required />
              ...
              <?php if ($_SESSION['type'] == 'Administrator') { ?>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control bold-select" name="branch_no" required>
                      <option class="bold-select" value="">Select Branch</option>
                      <?php
                      $stmt = $conn->prepare("SELECT id, full_name FROM branches_tbl ORDER BY id ASC");
                      $stmt->execute();
                      $branches = $stmt->fetchAll(PDO::FETCH_ASSOC);
                      foreach ($branches as $branch) {
                        echo '<option class="bold-select" value="' . $branch['id'] . '">' . htmlspecialchars($branch['full_name']) . '</option>';
                      }
                      ?>
                    </select>
                  </div>
