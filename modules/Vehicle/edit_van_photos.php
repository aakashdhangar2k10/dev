                                    ...
                                    <div class="row">
                                        <?php foreach ($images as $img): ?>
                                            <div class="col-md-4 image-card">
                                                ...
                                                <!-- Label Dropdown -->
                                                <!-- <label>Label</label>
                                                <select name="image_label[<?= $img['id'] ?>]" class="form-control">
                                                    <option value="" <?= $img['image_label'] == '' ? 'selected' : '' ?>>-- Select Label --</option>
                                                    <option value="Front View" <?= $img['image_label'] == 'Front View' ? 'selected' : '' ?>>Front View</option>
                                                    <option value="Back View" <?= $img['image_label'] == 'Back View' ? 'selected' : '' ?>>Back View</option>
                                                    <option value="Left Side" <?= $img['image_label'] == 'Left Side' ? 'selected' : '' ?>>Left Side</option>
                                                    <option value="Right Side" <?= $img['image_label'] == 'Right Side' ? 'selected' : '' ?>>Right Side</option>
                                                    ...
                                                    <option value="RC Book" <?= $img['image_label'] == 'RC Book' ? 'selected' : '' ?>>RC Book</option>
