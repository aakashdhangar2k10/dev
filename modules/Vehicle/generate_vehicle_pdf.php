...
<body>
  ...
  <div class="section">
    ...
    <table>
      ...
      <tr>
        <th>Fuel Type</th>
        <td><?= htmlspecialchars($vehicle['fuelType']) ?></td>
      </tr>

      <tr>
        <th>Engine Capacity (CC)</th>
        <td><?= htmlspecialchars($vehicle['engineCapacity']) ?></td>
      </tr>

      <tr>
        <th>Year of Manufacture</th>
        <td><?= htmlspecialchars($vehicle['yearOfManufacture']) ?></td>
      </tr>

      <!-- <tr>
        <th>Vehicle Age</th>
        <td><?= htmlspecialchars($vehicle['vehicleAge']) ?></td>
      </tr>

      <tr>
        <th>Wheel Plan</th>
        <td><?= htmlspecialchars($vehicle['wheelplan']) ?></td>
      </tr>

      <tr>
        <th>Last V5C Issued</th>
        <td><?= htmlspecialchars($vehicle['dateOfLastV5CIssued']) ?></td>
      </tr>

      <tr>
        <th>Type Approval</th>
        <td><?= htmlspecialchars($vehicle['typeApproval']) ?></td>
      </tr>

      <tr>
        <th>CO₂ Emissions</th>
        <td><?= htmlspecialchars($vehicle['co2Emissions']) ?></td>
      </tr>

      <tr>
        <th>Registration Place</th>
        <td><?= htmlspecialchars($vehicle['registrationPlace']) ?></td>
      </tr>

      <tr>
        <th>Tax Status</th>
        <td><?= htmlspecialchars($vehicle['taxStatus']) ?></td>
      </tr>

      <tr>
        <th>Tax Due Date</th>
        <td><?= htmlspecialchars($vehicle['taxDueDate']) ?></td>
      </tr> -->

      <tr>
        <th>MOT Status</th>
        <td><?= htmlspecialchars($vehicle['motStatus']) ?></td>
      </tr>

      <tr>
        <th>MOT Due Date</th>
        <td><?= htmlspecialchars($vehicle['motDueDate']) ?></td>
      </tr>
  ...
  <?php if ($inspection): ?>
    <div class="section">
      ...
      <table>
        ...
        <tr>
          <th>Driver's Cabin Condition</th>
